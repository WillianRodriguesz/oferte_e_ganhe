...
def export_talao():
    try:
        ...
        query = """
        SELECT 
            id, numero_remessa, qtd_talao, destinatario, status, 
        ...
        df['status'] = df['status'].fillna('Recebido')  # Status já filtrado na consulta, mas garantindo consistência
